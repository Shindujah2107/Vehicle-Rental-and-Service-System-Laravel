...
class ServiceBookingController extends ServicerController
{
    ...
    public function index()
    {
        ...
        return view('servicer.service_booking.view')
    ...
    public function edit($id)
    {
        ...
        return view('servicer.service_booking.edit')->with('service_booking', $service_booking);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/servicer/service_booking');
