...
class ServiceController extends ServicerController
{
    ...
    public function index()
    {
        ...
        return view('servicer.service.view')->with('services', $services);
    }
    ...
    {
        return view('servicer.service.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('servicer/service');
    ...
    public function edit($id)
    {
        ...
        return view('servicer.service.edit')->with('service', $service);
    }
