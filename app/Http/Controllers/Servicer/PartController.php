...
class PartController extends ServicerController
{
    ...
    {
        $parts = Part::all();
        return view('servicer.part.view')->with('parts', $parts);
    }
    ...
    {
        $part = Part::find($id);
        return view('servicer.part.edit')->with('part', $part);
    }
