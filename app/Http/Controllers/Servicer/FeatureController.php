...
class FeatureController extends ServicerController
{
    ...
    public function index()
    {
        ...
        return view('servicer.feature.view')->with('features', $features);
    }
    ...
    {
        return view('servicer.feature.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('servicer/feature');
    ...
    public function edit($id)
    {
        ...
        return view('servicer.feature.edit')->with('feature', $feature);
    }
