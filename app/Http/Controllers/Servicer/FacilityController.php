...
class FacilityController extends ServicerController
{
    ...
    public function index()
    {
        ...
        return view('servicer.facility.view')->with('facilities', $facilities);
    }
    ...
    {
        return view('servicer.facility.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('servicer/facility');
    ...
    public function edit($id)
    {
        ...
        return view('servicer.facility.edit')->with('facility', $facility);
    }
