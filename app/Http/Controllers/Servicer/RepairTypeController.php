...
class RepairTypeController extends ServicerController
{
    ...
    public function index()
    {
        ...
        return view('Servicer.repair_type.view')->with('repair_types', $repair_types);
    }
    ...
    public function create()
    {
        ...
        return view('Servicer.repair_type.add')
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Servicer/repair_type');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Servicer.repair_type.edit')->with([
