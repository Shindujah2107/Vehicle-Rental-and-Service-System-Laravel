...
class RepairBookingController extends AdminController
{
    ...
    public function index()
    {
        ...
        return view('admin.repair_booking.view')
    ...
    public function edit($id)
    {
        ...
        return view('admin.repair_booking.edit')->with('repair_booking', $repair_booking);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/repair_booking');
    }
