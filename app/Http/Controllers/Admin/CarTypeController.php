...
class CarTypeController extends AdminController
{
    ...
    public function index()
    {
        ...
        return view('admin.car_type.view')->with('car_types', $car_types);
    }
    ...
    public function create()
    {
        ...
        return view('admin.car_type.add')
    ...
    public function store(Request $request)
    {
        ...
        $car_type->no_of_seats = $request->input('no_of_seats');
    ...
    public function edit($id)
    {
        ...
        return view('admin.car_type.edit')->with([
            'car_type' => $car_type,
