...
class ImageRepairController extends AdminController
{
    ...
    public function index($id)
    {
        ...
        return view('admin.imagerepair.view')
    ...
    {
        $repair_type = RepairType::find($id);
        return view('admin.imagerepair.add')
            ->with('repair_type', $repair_type);
    }
    ...
    public function store($id, Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('/admin/repair_type/'.$id.'/imagerepair');
        }
    }
    ...
    public function edit($id, $imagerepair_id)
    {
        ...
        return view('admin.imagerepair.edit')
            ->with('repair_type', $repair_type)
    ...
    {
        $repair_type = RepairType::find($id);
        return view('admin.imagerepair.add_multiple')
            ->with('repair_type', $repair_type);
    }
